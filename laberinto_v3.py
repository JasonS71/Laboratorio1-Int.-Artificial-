...
def aux(direccion):
    ...
    if direccion == "arriba":
        ...
        list_aux = [0, alto-1, 1, 0]
    elif direccion == "derecha":
        list_aux = [1, ancho-1, 0, 1]
    ...
    #El comando "match" no funciona en python 3.8
    # match direccion:
...
def comprobacion_de_pared_cercano(direccion, laberinto, paredes):
    ...
    if direccion == "arriba":
        list_direccion = ["arriba", "derecha", "izquierda"]
    elif direccion == "abajo":
        list_direccion = ["abajo", "derecha", "izquierda"]
    elif direccion == "derecha":
        list_direccion = ["arriba", "abajo", "derecha"]
    elif direccion == "izquierda":
        list_direccion = ["arriba", "abajo", "izquierda"]
    else:
        print("ERROR")
    ...
    if (pared_aleatoria[list_aux[0]] != list_aux[1]
        and laberinto[pared_aleatoria[0]+list_aux[2]][pared_aleatoria[1]+list_aux[3]] == vacio 
        and laberinto[pared_aleatoria[0]-list_aux[2]][pared_aleatoria[1]-list_aux[3]] == camino):
